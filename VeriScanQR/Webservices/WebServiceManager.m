...
-(void)showDocuments:(NSString *)masterKey assetID:(NSString *)assetID withCompletionHandler:(CompletionHandler)block{
    ...
    [request setCompletionBlock:^{
      ...
      for (NSDictionary *dict in [rootDictionary objectForKey:@"hold"]) {
...
-(void)uploadPdfWithStatus:(NSString *)masterKey
       historyID:(NSString *)historyID
     contentType:(NSString *)contentType
         pdfData:(NSData*)pdf
     assetId:(NSString*)assetId
 status:(NSString*)status
document_id:(NSString*)document_id
                   version:(NSString*)versionno
...
withCompletionHandler:(CompletionHandler)handler {
  ...
  [request setPostValue:versionno forKey:@"version"];
  [request setPostValue:ticket_id forKey:@"ticket_id"];
  [request setPostValue:username forKey:@"username"];
  
   [request setPostValue:document_id forKey:@"document_id"];
  [request setPostValue:@"upload_document" forKey:@"action"];
