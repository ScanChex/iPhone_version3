//
//  CheckInTicketsViewController.m
//  ScanChex
//
...
@implementation CheckInTicketsViewController
...
+(id)initWithTickets{
    ...
    return [[[CheckInTicketsViewController alloc] initWithNibName:@"CheckInTicketsViewController" bundle:nil] autorelease];
}
